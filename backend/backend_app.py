...
POSTS = [
    ...
    {"id": 3, "title": "Veganer Speck aus Bananen?",
     "content": "Ein kulinarisches Experiment mit fragwürdigem Ausgang."},
    {"id": 4, "title": "Mars-Kolonie Update", "content": "Die ersten 100 Tage ohne WLAN – ein Überlebensbericht."},
    {"id": 5, "title": "Minimalismus im Kleiderschrank",
     "content": "Warum ich nur noch 7 identische schwarze T-Shirts besitze."},
    {"id": 6, "title": "Die Psychologie der Schriftarten",
     "content": "Warum dich Comic Sans heimlich aggressiv macht."},
    ...
    {"id": 16, "title": "DIY: Roboter-Staubsauger-Rennen",
     "content": "Wenn Technik im Wohnzimmer außer Kontrolle gerät."},
    {"id": 17, "title": "Warum wir Emojis brauchen",
     "content": "Eine linguistische Analyse des lachenden Kackhaufens."},
    {"id": 18, "title": "Yoga für Tastatur-Akrobaten", "content": "Dehnübungen für den schmerzenden Maus-Arm."},
    {"id": 19, "title": "Künstliche Intelligenz und Humor",
     "content": "Warum ChatGPT keine guten Flachwitze erzählen kann."},
    ...
    {"id": 28, "title": "Die vergessene Welt der Flohmärkte",
     "content": "Schätze finden zwischen altem Besteck und VHS-Kassetten."},
